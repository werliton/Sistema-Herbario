...
<section id="miolo_internos"><!-- Miolo Internos ( Tudo abaixo do banner principal está dentro dessa Section )-->
        ...
        <figure> <img src="<?php echo DIR_IMG; ?>/barra_agendconsultas.gif" height="79" title="O Hospital">   </figure> 
    ...
    <section class="informacoes_internos"><!-- Informações referente a page acessada ( conteúdo )-->
        ...
        <b>Aqui é possível realizar agendamentos de consultas</b>
        <br>
        <br>
        <?php echo form_open('../agendamentoConsulta/marcarConsulta',array('id'=>'formAgendamento')); ?> 
        <?php
        if (isset($listagem)) {
        ...
        <table width="100%" border="0" cellpadding="4" cellspacing="4">
            ...
            <tr>
                ...
                <td><label for="data"></label>
                    <input name="data" type="text" id="dataAgendamento" class="data" size="20" >
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td><label for="horario"></label>
                    <select name="horario" size="1" id="horaAgend">
                        <option value=" " selected="true">Selecione um horário</option>
            ...
            <tr>
                <td>&nbsp;</td>
                <td align="left">
                    <input type="submit" name="button" id="btnMarcar" value="Marcar Consulta"></td>
                <td>&nbsp;</td>
            </tr>
            <tr>
